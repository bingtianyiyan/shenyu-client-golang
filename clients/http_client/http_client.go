 ...
 * NewClient
 **/
func (hcc *ShenYuHttpClient) NewClient(clientParam interface{}) (client interface{}, createResult bool, err error) {
	acp, ok := clientParam.(*HttpClientParams)
	if !ok {
...
PersistInterface
*/
func (hcc *ShenYuHttpClient) PersistInterface(metaData interface{})(registerResult bool, err error){
...
PersistURI
*/
func (hcc *ShenYuHttpClient) PersistURI(uriRegisterData interface{})(registerResult bool, err error){
...
Close
*/
func (hcc *ShenYuHttpClient) Close(){
 ...
 **/
func (hcc *ShenYuHttpClient)  registerMetaData(metaData *model.MetaDataRegister) (registerResult bool, err error) {
 ...
 **/
func(hcc *ShenYuHttpClient) urlRegister(urlMetaData *model.URIRegister) (registerResult bool, err error) {
	params := map[string]string{}
...
/*
will remove by all client finish work
 */
func (hcc *ShenYuHttpClient) DeregisterServiceInstance(metaData interface{}) (deRegisterResult bool, err error) {
	panic("implement me")
}
/*
will remove by all client finish work
*/
func (hcc *ShenYuHttpClient) GetServiceInstanceInfo(metaData interface{}) (instances interface{}, err error) {
	panic("implement me")
}
/*
will remove by all client finish work
*/
func (hcc *ShenYuHttpClient) RegisterServiceInstance(metaData interface{}) (registerResult bool, err error) {
	panic("implement me")
}
